...
while cap.isOpened():
    ...
    top_row = np.hstack((frame, cv2.cvtColor(mog2_mask_resized, cv2.COLOR_GRAY2BGR), cv2.cvtColor(knn_mask_resized, cv2.COLOR_GRAY2BGR)))
    bottom_row = np.hstack((frame, result_mog2, result_knn))
